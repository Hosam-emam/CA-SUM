...
class VideoData(Dataset):
    def __init__(self, mode, video_type, split_index):
        ...
        self.datasets = ['/kaggle/input/datasets/michaelnabil88/tvsum-and-summe-feature-extraction/s3d_convnext_base_fused/norm_and_add/summe_fused_s3d_convnext_features.h5',
                         '/kaggle/input/datasets/michaelnabil88/tvsum-and-summe-feature-extraction/s3d_convnext_base_fused/norm_and_add/tvsum_fused_s3d_convnext_features.h5']
